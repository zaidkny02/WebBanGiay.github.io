    ...
    <div id="content">
        ...
        <div id="left-content">
            <form runat="server">
                ...
                <hr />
                 <center><p id="tongtien">Tổng tiền:</p></center>
                <br />
               <!--  <center><input type="button" id="btnthanhtoan" onclick="thanhtoan()"  value="Thanh toán"/></center> -->
                <center><asp:Button ID="Button1" runat="server" text="Thanh toán" onclientclick="thanhtoan()" OnClick="ThanhToan"/></center>
                 <asp:hiddenfield id="ValueHiddenField" value="" runat="server"/>
               <!-- <asp:Button runat="server" text="Thanh toan" OnClick="ThanhToan"/>   -->
            </form>
        </div>
